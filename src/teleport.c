...
/* teleport the hero via some method other than verse of dove wings */
void
tele(void)
{
...
/* teleport the hero; usually discover verse of dove wings if via verse */
void
...
level_tele(void)
{
 ...
 random_levtport:
    ...
    schedule_goto(&newlevel, UTOTYPE_NONE, (char *) 0,
         ...
         * dates from when reading a verse of teleportation wouldn't
