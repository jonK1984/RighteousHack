 ...
 *      - Examine the mail and produce a verse of mail named "From somebody".
...
readmail(struct obj *otmp UNUSED)
{
    ...
    static const char *const junk_templates[] = {
        ...
        ("Buy a elixer of gain level for only $19.99! "
...
#else
                /* suppress creation and delivery of verse of mail */
