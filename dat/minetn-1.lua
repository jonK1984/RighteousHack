...
des.object({ id = "rod of rebuke", coord = place[1], buc="uncursed", spe=0 })
des.object({ id = "rod of rebuke", coord = place[3], buc="uncursed", spe=0 })
des.object({ id = "rod of rebuke", coord = place[4], buc="uncursed", spe=0 })
des.object({ id = "rod of hidden arrows", coord = place[4], buc="uncursed", spe=0 })
des.object({ id = "rod of hidden arrows", coord = place[5], buc="uncursed", spe=0 })
