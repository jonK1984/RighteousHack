...
#define OBJCLASS2(idx, ch, basename, sname, sym, name, explain) \
    ...
    OBJCLASS(18,  0xED, ANOINTING, S_anointing_oil, "anointing oils", "bottle of anointing oil") /*Lettet phi*/
