...
GENERIC("anointing oil",   ANOINTING_CLASS,   GENERIC_ANOINTING),   /* [18] */
...
MARKER(LAST_GENERIC, GENERIC_ANOINTING)
...
TOOL("magic lamp",        "lamp", 0, 0, 1, 0, 15, 20, 50, COPPER, CLR_YELLOW,
                                                                MAGIC_LAMP),
TOOL("thurible",          "thurible", 0, 0, 0, 0, 45, 20, 10, GOLD, CLR_YELLOW,
                                                                THURIBLE),
/* other tools */
...
TOOL("writing tablet",        NoDes, 1, 0, 1, 1, 15,  2, 50, PLASTIC, CLR_RED,
                                                                MAGIC_MARKER),
/* traps */
...
/* wands ... */
#define ROD(name,typ,prob,cost,mgc,dir,metal,color,sn) \
    OBJECT(OBJ(name, typ),                                              \
           BITS(0, 0, 1, 0, mgc, 1, 0, 0, 0, 0, dir, P_NONE, metal),    \
           0, WAND_CLASS, prob, 0, 7, cost, 0, 0, 0, 0, 30, color, sn)
/* -------------------- RODS OF POWER (formerly wands) -------------------- */

ROD("light",                     "glass",      95, 100, 1, NODIR, GLASS,      HI_GLASS,     WAN_LIGHT),                  /* GENESIS 1 */
ROD("reveal secret things",      "balsa",      50, 150, 1, NODIR, WOOD,       HI_WOOD,      WAN_SECRET_DOOR_DETECTION),
ROD("understanding",            "crystal",    15, 150, 1, NODIR, GLASS,      HI_GLASS,     WAN_ENLIGHTENMENT),
ROD("heavenly host",             "maple",      45, 200, 1, NODIR, WOOD,       HI_WOOD,      WAN_CREATE_MONSTER),
ROD("ask and ye shall receive",  "pine",        5, 500, 1, NODIR, WOOD,       HI_WOOD,      WAN_WISHING),
ROD("nothing",                    "oak",        25, 100, 0, IMMEDIATE, WOOD,    HI_WOOD,      WAN_NOTHING),
ROD("rebuke",                    "ebony",      75, 150, 1, IMMEDIATE, WOOD,    HI_WOOD,      WAN_STRIKING),
ROD("divine concealment",        "marble",     45, 150, 1, IMMEDIATE, MINERAL, HI_MINERAL,   WAN_MAKE_INVISIBLE),
ROD("staggering wine",           "tin",        50, 150, 1, IMMEDIATE, METAL,   HI_METAL,     WAN_SLOW_MONSTER),
ROD("quickening",                "brass",      50, 150, 1, IMMEDIATE, COPPER,  HI_COPPER,    WAN_SPEED_MONSTER),
ROD("resist evil",               "copper",     50, 150, 1, IMMEDIATE, COPPER,  HI_COPPER,    WAN_UNDEAD_TURNING),
ROD("transformation",            "silver",     45, 200, 1, IMMEDIATE, SILVER,  HI_SILVER,    WAN_POLYMORPH),
ROD("cancellation",              "platinum",   45, 200, 1, IMMEDIATE, PLATINUM,CLR_WHITE,   WAN_CANCELLATION),
ROD("dove wings",                "iridium",    45, 200, 1, IMMEDIATE, METAL,   CLR_BRIGHT_CYAN, WAN_TELEPORTATION),
ROD("door shall be open",        "zinc",       25, 150, 1, IMMEDIATE, METAL,   HI_METAL,     WAN_OPENING),
ROD("seal entrance",             "aluminum",   25, 150, 1, IMMEDIATE, METAL,   HI_METAL,     WAN_LOCKING),
ROD("revelation",                "uranium",    30, 150, 1, IMMEDIATE, METAL,   HI_METAL,     WAN_PROBING),
ROD("move mountains",            "iron",       55, 150, 1, RAY,       IRON,    HI_METAL,     WAN_DIGGING),
/* ray wands – order must stay exactly as-is for buzz() */
ROD("hidden arrows",             "steel",      50, 150, 1, RAY,       IRON,    HI_METAL,     WAN_MAGIC_MISSILE),
ROD("consuming fire",            "hexagonal",  40, 175, 1, RAY,       IRON,    HI_METAL,     WAN_FIRE),
ROD("northern wind",             "short",      40, 175, 1, RAY,       IRON,    HI_METAL,     WAN_COLD),
ROD("tranquility",               "runed",      50, 175, 1, RAY,       IRON,    HI_METAL,     WAN_SLEEP),
ROD("final judgement",           "long",        5, 500, 1, RAY,       IRON,    HI_METAL,     WAN_DEATH),
ROD("lightning flash",           "curved",     40, 175, 1, RAY,       IRON,    HI_METAL,     WAN_LIGHTNING),
/*
ROD("light",           "glass", 95, 100, 1, NODIR, GLASS, HI_GLASS,
                                                            WAN_LIGHT),
ROD("secret door detection",
                        "balsa", 50, 150, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_SECRET_DOOR_DETECTION),
ROD("enlightenment", "crystal", 15, 150, 1, NODIR, GLASS, HI_GLASS,
                                                    WAN_ENLIGHTENMENT),
ROD("create monster",  "maple", 45, 200, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_CREATE_MONSTER),
ROD("wishing",          "pine",  5, 500, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_WISHING),
ROD("nothing",           "oak", 25, 100, 0, IMMEDIATE, WOOD, HI_WOOD,
                                                    WAN_NOTHING),
ROD("striking",        "ebony", 75, 150, 1, IMMEDIATE, WOOD, HI_WOOD,
                                                    WAN_STRIKING),
ROD("make invisible", "marble", 45, 150, 1, IMMEDIATE, MINERAL, HI_MINERAL,
                                                    WAN_MAKE_INVISIBLE),
ROD("slow monster",      "tin", 50, 150, 1, IMMEDIATE, METAL, HI_METAL,
                                                    WAN_SLOW_MONSTER),
ROD("speed monster",   "brass", 50, 150, 1, IMMEDIATE, COPPER, HI_COPPER,
                                                    WAN_SPEED_MONSTER),
ROD("undead turning", "copper", 50, 150, 1, IMMEDIATE, COPPER, HI_COPPER,
                                                    WAN_UNDEAD_TURNING),
ROD("polymorph",      "silver", 45, 200, 1, IMMEDIATE, SILVER, HI_SILVER,
                                                    WAN_POLYMORPH),
ROD("cancellation", "platinum", 45, 200, 1, IMMEDIATE, PLATINUM, CLR_WHITE,
                                                    WAN_CANCELLATION),
ROD("teleportation", "iridium", 45, 200, 1, IMMEDIATE, METAL,
                                     CLR_BRIGHT_CYAN, WAN_TELEPORTATION),
ROD("opening",          "zinc", 25, 150, 1, IMMEDIATE, METAL, HI_METAL,
                                                    WAN_OPENING),
ROD("locking",      "aluminum", 25, 150, 1, IMMEDIATE, METAL, HI_METAL,
                                                    WAN_LOCKING),
ROD("probing",       "uranium", 30, 150, 1, IMMEDIATE, METAL, HI_METAL,
                                                    WAN_PROBING),
ROD("digging",          "iron", 55, 150, 1, RAY, IRON, HI_METAL,
                                                    WAN_DIGGING),*/
/* magic missile ... lightning must be in this order; see buzz() */
/*ROD("magic missile",   "steel", 50, 150, 1, RAY, IRON, HI_METAL,
                                                    WAN_MAGIC_MISSILE),
ROD("fire",        "hexagonal", 40, 175, 1, RAY, IRON, HI_METAL,
                                                    WAN_FIRE),
ROD("cold",            "short", 40, 175, 1, RAY, IRON, HI_METAL,
                                                    WAN_COLD),
ROD("sleep",           "runed", 50, 175, 1, RAY, IRON, HI_METAL,
                                                    WAN_SLEEP),
ROD("death",            "long",  5, 500, 1, RAY, IRON, HI_METAL,
                                                    WAN_DEATH),
ROD("lightning",      "curved", 40, 175, 1, RAY, IRON, HI_METAL,
                                                    WAN_LIGHTNING),*/
/* extra descriptions, shuffled into use at start of new game */
ROD(NoDes,             "forked",  0, 150, 1, 0, WOOD, HI_WOOD, WAN1),
ROD(NoDes,             "spiked",  0, 150, 1, 0, IRON, HI_METAL, WAN2),
ROD(NoDes,            "jeweled",  0, 150, 1, 0, IRON, HI_MINERAL, WAN3),
#undef WAND
...
OBJECT(OBJ("splash of acid venom", "splash of venom"),
       ...
       VENOM_CLASS, 500, 0, 1, 0, 6, 6, 0, 0, 0, HI_ORGANIC, ACID_VENOM),
        ...
        /* potions ... */
#define ANOINTING(name,desc,mgc,power,prob,cost,color,sn) \
    OBJECT(OBJ(name, desc),                                             \
           BITS(0, 1, 0, 0, mgc, 0, 0, 0, 0, 0, 0, P_NONE, GLASS),      \
           power, ANOINTING_CLASS, prob, 0, 20, cost, 0, 0, 0, 0, 10, color, sn)
ANOINTING("wiggy gain ability",           "ruby",  1, 0, 40, 300, CLR_RED,
                                                        ANO_GAIN_ABILITY),
ANOINTING("restore ability",        "pink",  1, 0, 40, 100, CLR_BRIGHT_MAGENTA,
                                                        ANO_RESTORE_ABILITY),
ANOINTING("speed",            "dark green",  1, FAST, 40, 200, CLR_GREEN,
                                                        ANO_SPEED),
ANOINTING("invisibility", "brilliant blue",  1, INVIS, 40, 150, CLR_BRIGHT_BLUE,
                                                        ANO_INVISIBILITY),
ANOINTING("see invisible",       "magenta",  1, SEE_INVIS, 40, 50, CLR_MAGENTA,
                                                        ANO_SEE_INVISIBLE),
ANOINTING("healing",          "purple-red",  1, 0, 115, 20, CLR_MAGENTA,
                                                        ANO_HEALING),
ANOINTING("extra healing",          "puce",  1, 0, 45, 100, CLR_RED,
                                                        ANO_EXTRA_HEALING),
ANOINTING("gain level",            "milky",  1, 0, 20, 300, CLR_WHITE,
                                                        ANO_GAIN_LEVEL),
ANOINTING("enlightenment",        "swirly",  1, 0, 20, 200, CLR_BROWN,
                                                        ANO_ENLIGHTENMENT),
ANOINTING("monster detection",    "bubbly",  1, 0, 40, 150, CLR_WHITE,
                                                        ANO_MONSTER_DETECTION),
ANOINTING("object detection",      "smoky",  1, 0, 40, 150, CLR_GRAY,
                                                        ANO_OBJECT_DETECTION),
ANOINTING("gain energy",          "cloudy",  1, 0, 40, 150, CLR_WHITE,
                                                        ANO_GAIN_ENERGY),
ANOINTING("full healing",          "black",  1, 0, 10, 200, CLR_BLACK,
                                                        ANO_FULL_HEALING),
#undef ANOINTING
